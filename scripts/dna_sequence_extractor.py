...
def sequence_extractor_for_all_files(data_folder, output_folder):
    ...
    for fasta_file in os.listdir(data_folder):
        ...
        if os.path.isfile(fasta_path) and fasta_file.endswith(".fasta") or fasta_file.endswith(".fa"):
            # Process the file
...
# Example usage:
data_folder = 'raw_data'  # Folder where the raw FASTA files are located
output_folder = 'dna_sequences'  # Folder where the sequences will be saved
